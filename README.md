...
- 🔧 **Backend:** Python, FastAPI, Docker, Linux, SQL.
- ⚙️ **Systems / Low-level:** C, C++, Assembly.
- 🎯 **Long-term goal:** Computer hardware engineering — CPU & processor design.
- ⚡ Mobile: Dart = [ Flutter ].
- 🎓 Working toward top engineering programs, Oxford being my first choice.
...
![Chess.com](https://img.shields.io/badge/Chess.com-%2381B64C.svg?style=for-the-badge&logo=chessdotcom&logoColor=white)
